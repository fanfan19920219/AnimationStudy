...
- (UIBezierPath *)wavePathStarting {
    if (!_wavePathStarting) {
        ...
        [_wavePathStarting addCurveToPoint:CGPointMake(100.0, 80.0) controlPoint1:CGPointMake(30.0, 70.0)
                             controlPoint2:CGPointMake(40.0, 90.0)];
...
- (UIBezierPath *)wavePathHigh {
    if (!_wavePathHigh) {
        ...
        [_wavePathHigh addLineToPoint:CGPointMake(0.0, 20)];
